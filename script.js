            ...
            orders.forEach(order => {
                ...
                html += `
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary" onclick="updateShippingStatusOrder(${order.id})" style="height:40px; width:100px; font-size: 12px;">
    ...
    try {
        ...
        products.forEach(product => {
            ...
            row.innerHTML = `
                ...
                <td>
                    <button class="btn btn-primary" onclick="openModal('edit', ${product.id})" style=" height:40px; width:80px; font-size: 12px;">
                        <i class="ri-edit-line"></i> Edit
                    </button>
                    <br>
                    <button class="btn btn-danger" onclick="deleteProduct(${product.id})" style=" height:40px; width:80px;  font-size: 12px;">
    ...
    try {
        ...
        products.forEach(product => {
            ...
            row.innerHTML = `
                ...
                <td>₱${product.price.toLocaleString()}</td>
                <td>
                    <button class="btn btn-primary" onclick="openModal('edit', ${product.id})" style="height:40px; width:80px; font-size: 12px; margin-right: 5px;">
                        <i class="ri-edit-line"></i> Edit
                    </button>
                    <br>
                    <button class="btn btn-danger" onclick="deleteProduct(${product.id})" style=" height:40px; width:80px; font-size: 12px;">
...
async function updateShippingStatusOrder(orderId) {
